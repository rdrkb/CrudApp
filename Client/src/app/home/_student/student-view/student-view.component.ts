...
export class StudentViewComponent implements OnInit{
  ...
  refreshList() {
    this.getTotalPages().subscribe(totalItems => {
      ...
      this.studentService.getStudents(this.currentPage, this.itemsPerPage, this.university, this.department)
        .subscribe(data => {
  ...
  getTotalPages(): Observable<number> {
    return this.studentService.totalStudents(this.currentPage, this.itemsPerPage, this.university, this.department)
      .pipe(
        map(totalItems => {
          return totalItems;
        })
